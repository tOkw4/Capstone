...
# Helper function for WebsiteTraffic
 # 26. WebsiteTraffic

    def get_website_traffic(self, url):
        """Fetch website traffic rank using RapidAPI."""
        try:
            api_url = "https://similarweb-traffic.p.rapidapi.com/traffic"
            headers = {
                "x-rapidapi-key": "0b336f0389mshb18a50ab6f5ffd2p1e95a1jsn824b50edcc17",
            ...
            return rank if isinstance(rank, int) else -1

        except requests.exceptions.RequestException as e:
            print(f"Error fetching website traffic: {e}")
            return -1

    def WebsiteTraffic(self):
        """Calculate WebsiteTraffic feature."""
        try:
            rank = self.get_website_traffic(self.url)
            if rank > 0 and rank < 100000:
                return 1
            elif rank >= 100000:
                return 0
            else:
            ...
            print(f"Error in WebsiteTraffic feature: {e}")
            return -1
